  ...
  data: () => ({
    ...
    items: [
      ...
      },
      {
        ...
        model: false,
        children: [
          { icon: 'library_books', text: 'Las vocales', link: '/grado/1/tema/1' },
          { icon: 'library_books', text: 'El abecedario', link: '/grado/1/tema/2' },
          { icon: 'library_books', text: 'Las mayúsculas', link: '/grado/1/tema/3' },
          { icon: 'library_books', text: 'Las minúsculas', link: '/grado/1/tema/4' },
          { icon: 'library_books', text: 'Sustantivos propios', link: '/grado/1/tema/5' },
          { icon: 'library_books', text: 'Sustantivos comunes', link: '/grado/1/tema/6' },
          { icon: 'library_books', text: 'Palabras largas y cortas', link: '/grado/1/tema/7' },
          { icon: 'library_books', text: 'Diccionario', link: '/grado/1/tema/8' },
          { icon: 'library_books', text: 'Separación silábica', link: '/grado/1/tema/9' },
          { icon: 'library_books', text: 'Sujeto y predicado', link: '/grado/1/tema/10' },
          { icon: 'library_books', text: 'Las sílabas', link: '/grado/1/tema/11' },
          { icon: 'library_books', text: 'El acento gráfico', link: '/grado/1/tema/12' },
          { icon: 'library_books', text: 'Dictado', link: '/grado/1/tema/13' }
        ]
      },
      {
        icon: 'keyboard_arrow_up',
        ...
        model: false,
        children: [
          { icon: 'library_books', text: 'El alfabeto', link: '/grado/2/tema/1' },
          { icon: 'library_books', text: 'Uso de las mayúsculas', link: '/grado/2/tema/2' },
          { icon: 'library_books', text: 'El cartel', link: '/grado/2/tema/3' },
          { icon: 'library_books', text: 'Fichas del libro', link: '/grado/2/tema/4' },
          { icon: 'library_books', text: 'La sílaba', link: '/grado/2/tema/5' },
          { icon: 'library_books', text: 'Uso de la r', link: '/grado/2/tema/6' },
          { icon: 'library_books', text: 'Poemas,rimas y versos', link: '/grado/2/tema/7' },
          { icon: 'library_books', text: 'Adjetivos calificativos', link: '/grado/2/tema/8' },
          { icon: 'library_books', text: 'La descripción', link: '/grado/2/tema/9' },
          { icon: 'library_books', text: 'Oraciones afirmativas', link: '/grado/2/tema/10' },
          { icon: 'library_books', text: 'Uso de la b y v', link: '/grado/2/tema/11' },
          { icon: 'library_books', text: 'Trabalenguas', link: '/grado/2/tema/12' },
          { icon: 'library_books', text: 'Chistes', link: '/grado/2/tema/13' },
          { icon: 'library_books', text: 'Adivinanzas', link: '/grado/2/tema/14' },
          { icon: 'library_books', text: 'El diálogo', link: '/grado/2/tema/15' },
          { icon: 'library_books', text: 'La carta', link: '/grado/2/tema/16' },
          { icon: 'library_books', text: 'El punto', link: '/grado/2/tema/17' },
          { icon: 'library_books', text: 'Anécdotas', link: '/grado/2/tema/18' }
        ]
      },
      {
        icon: 'keyboard_arrow_up',
        ...
        children: [
          ...
          { icon: 'library_books', text: 'El chiste', link: '/grado/3/tema/5' },
          { icon: 'library_books', text: 'Discurso directo', link: '/grado/3/tema/6' },
          { icon: 'library_books', text: 'Lectura de mapas', link: '/grado/3/tema/7' },
          { icon: 'library_books', text: 'La descripción', link: '/grado/3/tema/8' },
          { icon: 'library_books', text: 'Tipos de textos', link: '/grado/3/tema/9' },
          { icon: 'library_books', text: 'Interpretación de símbolos', link: '/grado/3/tema/10' }
        ]
      },
      {
        icon: 'keyboard_arrow_up',
        ...
        model: false,
        children: [
          { icon: 'library_books', text: 'Propiedades y tipos de textos', link: '/grado/4/tema/1' },
          { icon: 'library_books', text: 'Ortografía', link: '/grado/4/tema/2' },
          { icon: 'library_books', text: 'Aspectos sintácticos y semánticos', link: '/grado/4/tema/3' },
